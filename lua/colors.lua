...
---@field blue string
---@field purple string
---@field search_yellow string
---@field search_orange string
---@field cursor_line string

local M = {}

---Simple wrapper to setup highlight
---@param group string
...
---Set colors for the schema
---@param name string
---@param c Colors
function M.set_colors(name, c)
    ...
    hi("FloatBorder", { fg = c.fg0, bg = c.bg0 })
